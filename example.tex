...
\begin{figure}[H]
\centering
\input{ultikz/lineplot_basic.tikz}
...
\begin{figure}[H]
\centering
\input{ultikz/lineplot_log1.tikz}
\input{ultikz/lineplot_log2.tikz}
...
\begin{figure}[H]
\centering
\input{ultikz/lineplot_customticks.tikz}
\caption{\emph{Examples of GAs with different shape parameter values and PHSs of different degrees.}}
\label{fig:payoff}
\end{figure}
%
...
\begin{figure}[H]
\centering
\input{ultikz/lineplot_ribbon.tikz}
...
\begin{figure}[H]
\centering
\input{ultikz/histplot_basic.tikz}\\
...
\begin{figure}[H]
\centering
\input{ultikz/embedded_heatmap.tikz}
